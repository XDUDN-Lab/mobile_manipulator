...
from functions import gridValue,informationGain2,isOldFrontier
...
def callBack(data,args):
    ...
    # transform from local map point to global map
...
#---------------------------------------------------------------------------------------------------------------
    ...
    pub2 = rospy.Publisher('frontiers', Marker, queue_size=10)
    ...
    #Set frame ID and timestamp.  See the TF tutorials for information on these.
    ...
    #Set marker action for latched frontiers.  Options are ADD, DELETE, and new in ROS Indigo: 3 (DELETEALL)
    ...
    #Set marker action for centroids.  Options are ADD, DELETE, and new in ROS Indigo: 3 (DELETEALL)
